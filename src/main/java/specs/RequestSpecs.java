...
public class RequestSpecs {
    ...
    private static final Map<String, String> authHeaders = new HashMap<>(
            Map.of("admin", Config.getAdminAuth())
    );
    ...
    public static RequestSpecification authAsUserSpec(String userAuthHeader) {
        return defaultRequestBuilder()
    ...
    public static RequestSpecification authAsUser(String username, String password) {
        ...
        if (!authHeaders.containsKey(username)) {
            ...
            userAuthHeader = new ValidatedCrudRequester<LoginUserRequest>(
                    new HttpRequest(
